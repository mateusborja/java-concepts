...
public class VetorObject {
    ...
    public boolean adicionarVetor(Object elemento) {
    ...
    public Object buscarVetorExistente(Object elemento) {
    ...
    public int buscarVetorExistenteOp3(Object elemento) {
        for (int i = 0; i < this.elementos.length; i++) {
            if (this.elementos[i].equals(elemento)) {
                return i;
            }
    ...
    public boolean adicionarVetorQlqrPos(int posicao, Object elemento) {
    ...
    public void adicionarVetorQlqrPosSemRetorno(int posicao, Object elemento) {
        if (!(posicao > 0 && posicao < this.tamanho)) {
            throw new IllegalArgumentException("Posição Inválida!");
        }
        this.aumentaCapacidade();
